<?php
$get5stars = '<div class="tp-stars tp-stars--5">
...
$get4stars = '<div class="tp-stars tp-stars--4">
    <div style="position: relative; height: 0; width: 100%; padding: 0; padding-bottom: 18.326693227091635%;">
        <svg viewBox="0 0 251 46" xmlns="http://www.w3.org/2000/svg" style="position: absolute; height: 100%; width: 100%; left: 0; top: 0;">
            <g class="tp-star">
                <path class="tp-star__canvas" fill="#000" d="M0 46.330002h46.375586V0H0z"></path>
    ...
    <div class="container">
        <div id="tp-widget-wrapper" class="tp-widget-wrapper visible">
            <div id="wrapper-left" class="wrapper-left">
                <!-- Human Score -->
                <div class="tp-widget-humanscore"><a id="trust-score" target="_blank"><?php _cz('tp_trustbox_rating'); ?></a></div>
                <!-- Stars -->
                <div class="tp-widget-stars">
                    <a id="tp-widget-stars" target="_blank">
                        <div class="">
                            <?php
                            $mainstars = cz('tp_trustbox_main_star');
                            if($mainstars=='4'){
                                echo $get4stars;
                            }
                            if($mainstars=='5'){
                ...
                <div class="tp-widget-businessinfo">
                    <a id="translations-basedon" target="_blank">Based on </a><a target="_blank" href="<?php _cz('tp_trustbox_link'); ?>"><strong class="bold-underline"><?php _cz('tp_trustbox_reviews_count'); ?> reviews</strong></a>
                </div>
                <!-- Logo -->
                <div id="tp-widget-logo" class="tp-widget-logo">
                    <a id="profileLink" target="_blank" href="<?php _cz('tp_trustbox_link'); ?>"><div class="">
            ...
            <div id="wrapper-right" class="wrapper-right">
                <div id="tp-widget-reviews-wrapper" class="tp-widget-reviews-wrapper">
                    <div id="tp-widget-reviews" class="tp-widget-reviews" style="user-select: none; ">


                        <?php
                        foreach (cz('trust_reviews') as $key => $item) {
...
<div class="tp-widget-review">
    ...
    <div class="header">%1$s</div>
    <div class="text">%2$s</div>
    <div class="name">%3$s</div>
</div>',
                                $item[ 'title' ],
                                $item[ 'text' ],
                                $item[ 'author' ],
                                $item[ 'date' ],
                                $item[ 'stars' ] == '4' ? $get4stars : $get5stars
