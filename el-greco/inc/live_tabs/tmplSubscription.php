...
?><form action="live_cstm_save" class="live_cstm_save">
    <div class="fields_block">
        <h4><?php _e( 'Subscription Form Settings', 'elgreco' ); ?></h4>
        <div class="fields_cont">
            <?php
            cb_checkbox(__( 'Show subscription form', 'elgreco'),'tp_subscribe_show','',$data);
            cb_textarea(__( 'Subscription form code', 'elgreco' ),'tp_subscribe','',$data);
            ?>
