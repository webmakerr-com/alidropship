    ...
    let SearchForm = {
        ...
        handler : function() {
            ...
            $(document).on('click', '#create_cat', function(){
                ...
                $this.request('save_settings', $this.prepareForm( $('#collapseSettings') ), $this.savedImportSettins);
            });
                ...
                .then( function (value) {
                    if( typeof value.html === 'object') {
                        ...
                        if( value.html.hasOwnProperty('data') && value.html.data !== null && value.html.data.hasOwnProperty('saleVolume') ) {
                            ...
                            response.url      = '//www.aliexpress.com/item//'+response.id+'.html';
