        ...
        <div class="track-modal-content">
            ...
            <template v-else>
                ...
                <div class="tracking-info">
                    <div class="tracking"><span class="name">Tracking ID:</span> <a target="_blank" :href="`https://global.cainiao.com/newDetail.htm?mailNoList=${trackNum}`">{{trackNum}}</a></div>
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            jQuery('body').append('<iframe id="iframediv" :src="https://t.17track.net/" width="500" height="500" style="position: absolute;left: -99999px;"></iframe>');
        ...
        methods:{
            ...
            parseParams(obj){
              console.log(obj);
              let json  = obj[0].outerText;

              let trackingInfoList = jQuery.parseJSON(json);
            ...
            trankInfo(num){
              ...
              jQuery('#iframediv').attr('src', `https://global.cainiao.com/global/detail.json?mailNos=${num.trim()}&lang=en-US&language=en-US`);
