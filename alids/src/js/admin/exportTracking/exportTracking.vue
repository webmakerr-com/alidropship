    ...
    <div v-if="open" class="product-export-modal"  >
        ...
        <div class="modal-content">
            <div class="header-modal">
                <div class="title">Export tracking</div>
...
<script>
    export default {
        ...
        data(){
            return {
                ...
                list : [
                    ...
                    {
                        value : 'aliExpress_order_number',
                        name : 'AliExpress order number'
                    },
                    {
                        value : 'tracking_id',
                        name : 'Tracking ID'
        ...
        created(){
            let self = this;
             jQuery('body').on('click', '#btn-export-tracking', function (e) {
                 let href = jQuery('#link-export-tracking').val();
